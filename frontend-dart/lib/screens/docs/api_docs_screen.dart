  ...
  Widget _buildDelegationDocs() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Music Control Delegation APIs',
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 16),
          _buildEndpointCard(
            title: 'Delegate Music Control',
            endpoint: '/delegation/delegate/',
            method: 'POST',
            description: 'Delegate music control to another user',
            requestParams: '''
{
  "user_id": "integer",
  "device_id": "string",
  ...
  "duration": "integer"  // Duration in minutes, 0 for indefinite
}
            ...
            responseFormat: '''
{
  ...
  "expires_at": "datetime"
          ...
          _buildEndpointCard(
            title: 'Get Delegations Made',
            endpoint: '/delegation/made/',
            method: 'GET',
            description: 'Get all delegations made by the user',
            requestParams: '''
Headers:
Authorization: Token <token>''',
            responseFormat: '''
{
  "delegations": [
    ...
    ...
          ...
          _buildEndpointCard(
            title: 'Get Delegations Received',
            endpoint: '/delegation/received/',
            method: 'GET',
            description: 'Get all delegations received by the user',
            requestParams: '''
Headers:
Authorization: Token <token>''',
            responseFormat: '''
  ...
  "delegations": [
    ...
    ...
          ...
          _buildEndpointCard(
            ...
            endpoint: '/delegation/{delegation_id}/revoke/',
            method: 'POST',
            description: 'Revoke a delegation made by the user',
            requestParams: '''
Headers:
Authorization: Token <token>''',
            responseFormat: '''
{
  "message": "Delegation revoked successfully"
          ...
          _buildEndpointCard(
            title: 'Control Delegated Device',
            endpoint: '/delegation/control/',
            method: 'POST',
            description: 'Control a device that has been delegated to the user',
            requestParams: '''
{
  "delegation_id": "integer",
  "action": "string",  // "play", "pause", "skip", "volume", etc.
            ...
            responseFormat: '''
{
  ...
  "status": "string"  // Current state after command
}''',
            isImplemented: false,
          ),
          ...
          _buildEndpointCard(
            ...
            endpoint: '/delegation/register_device/',
            method: 'POST',
            description: 'Register a device for delegation',
            requestParams: '''
{
  "device_id": "string",
  "device_name": "string",
