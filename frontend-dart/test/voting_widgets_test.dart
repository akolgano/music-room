  ...
  group('Voting Widgets Tests', () {
    ...
    group('VotingStatsCard', () {
      ...
      testWidgets('should display voting statistics', (WidgetTester tester) async {
        ...
        expect(find.text('5'), findsOneWidget); // Total votes
        expect(find.text('2'), findsOneWidget); // Track count
        expect(find.text('3.0'), findsOneWidget); // Top score
      ...
      testWidgets('should handle tracks with no votes', (WidgetTester tester) async {
        ...
        expect(find.text('0'), findsOneWidget); // Total votes
        expect(find.text('1'), findsOneWidget); // Track count
        expect(find.byIcon(Icons.star), findsNothing); // No top score when no votes
      });
    });
    ...
    group('VoteStats', () {
      test('should calculate score color correctly', () {
        ...
        const mediumScoreStats = VoteStats(
          ...
          downvotes: 0,
          userHasVoted: false,
          voteScore: 0.5, // Between 0.3 and 0.6 = orange
        );
