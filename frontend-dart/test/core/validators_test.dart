...
void main() {
  group('AppValidators Tests', () {
    test('AppValidators should have required validator', () {
      print('Testing: AppValidators should have required validator');
    ...
    test('AppValidators should have email validator', () {
      print('Testing: AppValidators should have email validator');
    ...
    test('AppValidators should have password validator', () {
      print('Testing: AppValidators should have password validator');
    ...
    test('AppValidators should have username validator', () {
      print('Testing: AppValidators should have username validator');
    ...
    test('AppValidators should have phoneNumber validator', () {
      print('Testing: AppValidators should have phoneNumber validator');
    ...
    test('AppValidators should have playlistName validator', () {
      print('Testing: AppValidators should have playlistName validator');
    ...
    test('AppValidators should have description validator', () {
      print('Testing: AppValidators should have description validator');
