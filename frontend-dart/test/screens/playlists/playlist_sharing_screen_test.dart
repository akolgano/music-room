...
import 'package:music_room/screens/playlists/sharing_playlists.dart';
...
void main() {
  group('Playlist Sharing Screen Tests', () {
    ...
    test('PlaylistSharingScreen should handle public sharing', () {
      ...
      final publicLink = 'https://localhost:8000/playlist/${playlistId}';
      
      expect(publicLink, contains(playlistId));
      expect(publicLink, startsWith('https://localhost:8000'));
